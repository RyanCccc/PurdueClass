...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'course_course', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Course.description'
        db.alter_column(u'course_course', 'description', self.gf('django.db.models.fields.TextField')(default=''))
