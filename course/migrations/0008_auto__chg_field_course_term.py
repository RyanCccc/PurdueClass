...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.term'
        db.alter_column(u'course_course', 'term_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['course.Term']))

    def backwards(self, orm):

        # Changing field 'Course.term'
        db.alter_column(u'course_course', 'term_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['course.Term'], null=True))
